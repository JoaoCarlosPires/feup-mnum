...
float kn(float x, float y) {
    return (((-1*y+4*x-5)*(-1*y*y+1.302883445709755*log(x)+x)-1.0*((1.302883445709755/x)+1.0)*(-1*x+2*x*x-5*x+1))/(((1.302883445709755/x)+1)*x-2*(-1*y+4*x-5)*y));
...
float hn(float x, float y) {
    return ((x*(-1*y*y+1.302883445709755*log(x)+x)-2*y*(-1*x*y+2*x*x-5*x+1))/(((1.302883445709755/x)+1)*x-2*(-1*y+4*x-5)*y));
